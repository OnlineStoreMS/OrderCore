  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'allocate', name: 'Allocate', component: () => import('../views/order/AllocateList.vue'), meta: { title: '分配管理', section: '履约' } },
        { path: 'bindings', name: 'Bindings', component: () => import('../views/binding/BindingList.vue'), meta: { title: '厂家绑定', section: '履约' } },
      ],
    },
  ],
})
